...
" hi def link cppSTLtypedef      Type
hi def link cppSTLenum         Type
" hi def link cppSTLios          Function
hi def link cppSTLconcept      Type
...
" my fixes {{{1
" TODO: allow some Type highlights e.g. auto_ptr,...
syn keyword cppStatement auto
syn keyword cppConstant this
syn clear cppSTLbool cppSTLfunction cppSTLiterator cppSTLtype cppSTLtypedef cppSTLios cppSTLvariable
